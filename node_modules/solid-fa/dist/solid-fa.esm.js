import { insert, createComponent, effect, setAttribute, classList, style as style$2, template } from 'solid-js/web';
...
const _tmpl$$2 = template(`<svg><path></path></svg>`, 4, true),
      _tmpl$2 = template(`<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><g><g></g></g></svg>`, 6);
function Fa(props) {
  props = mergeProps({
    scale: 1,
    translateX: 0,
...
const _tmpl$$1 = template(`<span></span>`, 2);
...
const _tmpl$ = template(`<span class="solid-fa-layers-text"><span></span></span>`, 4);
